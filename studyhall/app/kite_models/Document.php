...
class Document{
    ...
    public function createDocument($username, 
        ...
        $query_string = sprintf("SELECT * FROM `Document` WHERE doc_name LIKE '%s%%' AND path_to_doc='%s';", $doc_name, $path_to_doc);
        ...
        db_add("Document", sprintf("'%d', '%s', '%s', '%s', '%s', '%s', '%s', '0', '0', 'false'", $doc_id, $username, $class_name, $subject, $new_doc_name, $doc_type, $path_to_doc));
